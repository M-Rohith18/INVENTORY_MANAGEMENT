...
urlpatterns = [
    ...
    path('api/forgot-password/', views.ForgotPasswordAPIView.as_view(), name='forgot-password-api'),
    # path('reset_password/<uidb64>/<token>/',views.reset_password,name="reset_password"),
    path('api/reset-password/<uidb64>/<token>/', views.ResetPasswordAPIView.as_view(), name='reset-password-api'),
    ...
    # View Edit Delete
    path('api/items/<int:pk>/delete/', views.ItemSoftDeleteAPIView.as_view(), name='item_soft_delete'),
    path('api/items/<int:pk>/view/', views.ViewItemAPIView.as_view(), name='item_detail_api'),
    path('items/<int:pk>/edit/', views.edit_item_template, name='item_edit_template'),
    path('api/items/<int:pk>/', views.EditItemAPIView.as_view(), name='item_edit_api'),        
